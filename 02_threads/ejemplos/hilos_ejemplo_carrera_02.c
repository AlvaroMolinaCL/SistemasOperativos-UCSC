// Para compilar usar: gcc -o hilos_ejemplo_carrera_02.c hilos_ejemplo_carrera_02.c -lncurses -lpthread -DMUTEX
...
typedef struct
{                 // Se define una estructura para pasar los
...
int main(void)
{
    ...
    while (x < 40)
    {
        ...
        if (drand48() < 0.5)
            x++; // Avanza una posicion con probabilidad 0.5
    }
